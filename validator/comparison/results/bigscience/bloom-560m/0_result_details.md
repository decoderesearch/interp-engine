...
| [tlens_v2](tlens_v2.json) | ✅ | ok | float32 | v3.8.1 | 32 | 0 | 0 | 0 |
| [tlens_v3](tlens_v3.json) | [🐞](https://github.com/TransformerLensOrg/TransformerLens/issues/1639) | ok | float32 | v3.8.1 | 24 | 1 | 7 | 0 |
...
| tlens_v3 | `mlp_out` | 0 | ⚠️ | 0.652846 | 1.4701 | 8.1542 | direction differs (cos 0.652846 below the `tlens` gate of 0.98); same direction, different scale (rel 1.4701 above the `tlens` gate of 0.5) |
